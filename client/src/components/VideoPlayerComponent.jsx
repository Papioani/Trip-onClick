   ...
   return (
      <div>
         <ReactPlayer ref={playerRef} 
                      ...
                      style ={{ pointerEvents: 'none' }} /* it disables mouse events (such as hover, click, etc.) 
                     on the specified element and its children */
                      width="100%" 
                      height="auto"/>  
                      <button type="button" id="enter-button ">Your next road trιp is just a click awaΥ</button> 
      </div>
   )
};
